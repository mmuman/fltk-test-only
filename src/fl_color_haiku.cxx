//
// "$Id: fl_color_haiku.cxx 10739 2015-05-30 13:46:59Z manolo $"
//
// Haiku color functions for the Fast Light Tool Kit (FLTK).
//
...
void Fl_Haiku_Graphics_Driver::color(Fl_Color i) {
  ...
  fl_gc->SetHighColor(c);
}

void Fl_Haiku_Graphics_Driver::color(uchar r, uchar g, uchar b) {
...
//
// End of "$Id: fl_color_haiku.cxx 10739 2015-05-30 13:46:59Z manolo $".
//
